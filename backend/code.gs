...
var SHEET_SCHEMA = {
  ...
  Flaechen: ['ID', 'Name', 'KatastralGemeinde', 'Parzellennummer', 'FlaecheHa', 'Besitzart', 'Nutzungsart', 'Rebsorte', 'AnzahlPflanzen', 'ArbeitsablaufJSON', 'GeoJSON', 'Notiz', 'ErstelltVon', 'ErstelltAm', 'Aktiv'],
  ...
  Feldarbeiten: ['ID', 'FlaecheID', 'Schritt', 'Datum', 'Notiz', 'ErfasstVon', 'ErfasstAm'],
